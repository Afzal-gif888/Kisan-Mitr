  ...
  return (
    ...
    >
      ...
      <div className="flex-1 text-left min-w-0">
        <h3 className="font-black text-xl text-[#1B5E20] leading-none tracking-tighter transition-colors break-words uppercase italic">
          {language === "te" ? (translatedName || soilName) : soilName}
        </h3>
        {language === "te" && (
            <p className="text-[#1B5E20]/50 font-black text-[9px] uppercase tracking-[0.2em] mt-2 pl-1 italic">
                ● {soilName}
            </p>
        )}
      </div>
