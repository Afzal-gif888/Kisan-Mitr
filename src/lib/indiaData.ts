/**
 * Comprehensive mapping of Indian States and Union Territories to their respective districts.
 * Data sourced from administrative records (iGOD).
 */
export const indiaDistricts: Record<string, string[]> = {
  ...
  "Gujarat": [
    ...
    "Kachchh", "Kheda (Nadiad)", "Mahisagar", "Mehsana", "Morbi", "Narmada (Rajpipla)",
  ...
  "Punjab": [
    ...
    "Ludhiana", "Mansa", "Moga", "Muktsar", "Nawanshahr (Shahid Bhagat Singh Nagar)",
  ...
  "Uttar Pradesh": [
    ...
    "Sant Kabir Nagar", "Shahjahanpur", "Shamli (Prabuddha Nagar)", "Shravasti",
  ...
  "West Bengal": [
    ...
    "Paschim Medinipur (West Medinipur)", "Paschim Bardhaman (West Bardhaman)",
